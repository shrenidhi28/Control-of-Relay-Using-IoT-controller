...
void loop() {</br>
  ...
  x=digitalRead(s);</br>
  if (x==1){</br>
    digitalWrite(re,HIGH);</br>
</br>
  }</br>
  else{</br>
    digitalWrite(re,LOW);</br>
</br>
  }</br>
...
## OUTPUT:
<img width="493" alt="image" src="https://github.com/anishkumar-Embedded/Control-of-Relay-Using-IoT-controller/assets/155261096/a860b681-f249-4954-ba6c-27ac7ef4ac86">
